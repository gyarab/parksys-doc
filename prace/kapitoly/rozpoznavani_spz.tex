...
Proces neprobíhá ne jednom vlákně. Jakmile se pořídí fotografie, tak začně odpočet kolem jedné
sekundy, po kterém se pořídí další, a zároveň se už posílá první fotografie backendu.

\begin{figure}[!htb] \centering
  \includegraphics[width=145mm]{../img/app_lifecycle.jpg}
