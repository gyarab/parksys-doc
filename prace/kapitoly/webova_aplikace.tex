...
Místo toho bude klient posílá token v hlavičce \textit{Authorization}.
...
Tučne jsou označeny rezervovaná slova a skáláry již obsažené v základním GraphQL. Kurzívou jsou označeny typu z balíčku \textit{graphql-scalars}.
