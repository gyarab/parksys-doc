...
Obrazovka také zobrauje čas posledního kontaktu.
...
\begin{figure} \centering
  ...
  \caption{Stránka pro zařízení s hlavním menu.}
...
Je-li potřeba mít ty samá pravidla několik týdnů, měsíců nebo let, lze požadovaný rozsah vybrat
a zkopírovat buď na několik míst, nebo zvolit počáteční datum a počet zkopírování.
...
aplikovaná pravidla a vypočítaná částku k zaplacení, a také vozidla, kdy parkovala a kolik
bylo celkem naúčtováno.
