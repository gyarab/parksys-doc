...
a handler endpointu \textit{/capture-Image/:id} (viz \ref{endpoints}) je dekóduje zpět.
...
HOF funkci, které dáme reducer, a ona změny, které způsobí, někam uloží. \citep[][]{reduxpersist}
